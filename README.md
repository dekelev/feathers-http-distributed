...
| timeout | number | `0` | no | Request timeout in milliseconds.<br/><br/>Set to `0` to disable redirects.<br/><br/>If timeout enabled, it will include the time spent on retries by default. |
