...
| timeout | number | `0` | no | Request timeout in milliseconds.<br/>Set to `0` to disable redirects.<br/><br/>If timeout enabled, it will include the time spent on retries by default. |
...
| maxRedirects | number | `5` | no | Maximum redirects to follow.<br/>Set to `0` to disable redirects. |
