...
// This is the remote Feathers service abstraction
class RemoteService {
  ...
  async find (params) {
    ...
    try {
      const result = await requester.send({ type: 'find', path: this.path, params });
      debug('Successfully find() remote service on path ' + this.path);
      return result;
    } catch (error) {
      throw convert(error.response.data);
    }
  }
  ...
  async get (id, params) {
    ...
    try {
      const result = await requester.send({ type: 'get', path: this.path, id, params });
  ...
  async create (data, params) {
    ...
    try {
      const result = await requester.send({ type: 'create', path: this.path, data, params });
  ...
  async update (id, data, params) {
    ...
    try {
      const result = await requester.send({ type: 'update', path: this.path, id, data, params });
  ...
  async patch (id, data, params) {
    ...
    try {
      const result = await requester.send({ type: 'patch', path: this.path, id, data, params });
  ...
  async remove (id, params) {
    ...
    try {
      const result = await requester.send({ type: 'remove', path: this.path, id, params });
