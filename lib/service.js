...
class RemoteService {
  ...
  async find (params) {
    debug('Requesting find() remote service on path ' + this.path, filterParams(params, this.requester.excludeParams));
    try {
  ...
  async get (id, params) {
    debug('Requesting get() remote service on path ' + this.path, id, filterParams(params, this.requester.excludeParams));
    try {
  ...
  async create (data, params) {
    debug('Requesting create() remote service on path ' + this.path, data, filterParams(params, this.requester.excludeParams));
    try {
  ...
  async update (id, data, params) {
    debug('Requesting update() remote service on path ' + this.path, id, data, filterParams(params, this.requester.excludeParams));
    try {
  ...
  async patch (id, data, params) {
    debug('Requesting patch() remote service on path ' + this.path, id, data, filterParams(params, this.requester.excludeParams));
    try {
  ...
  async remove (id, params) {
    debug('Requesting remove() remote service on path ' + this.path, id, filterParams(params, this.requester.excludeParams));
    try {
